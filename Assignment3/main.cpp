...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
    ...
    Eigen::Matrix4f persp_to_ortho_matrix = Eigen::Matrix4f::Identity();
    double top=-1*tan(eye_fov/180*MY_PI/2)*zNear;
    ...
    persp_to_ortho_matrix<< zNear,0,0,0,\
                            0,zNear,0,0,\
                            0,0,zNear+zFar,-1*(zNear*zFar),\
                            0,0,1,0;
    projection=orthographic_matrix*persp_to_ortho_matrix;
    return projection;
}
